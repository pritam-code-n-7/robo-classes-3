...
import "swiper/css";
import Data from "../../data/programmingData.json";
  ...
  return (
    <div className="flex flex-col p-8 gap-4 mb-20">
      <div className="flex flex-col items-center">
        <p className="text-4xl font-extrabold mb-4">Programming Courses</p>
      ...
      <p className="font-extrabold px-5">Programming Courses</p>
